<%-- 
    ...
    Created on : Oct 21, 2018, 11:38:41 PM
    Author     : sunny
--%>
...
.bg-img {
  /* The image used */
  background-image: url("image/pl2.jpg");
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li><a href="index.html"> <span class="glyphicon glyphicon-home"></span>Home</a></li>
        ...
        <div class="bg-img">
 <form action="PatientLogin" class="container">
    <h1>Login</h1>
    <div class="imgcontainer">
        <img src="image/dc3.jpg" alt="Avatar" class="avatar">
    </div>
